    ...
    const games = [
      {
        ...
        label: "Valorant",
        tabIcon: "i-rank",
        heroBg: "assets/valorant-bg.webp",
      ...
      },
      {
        ...
        label: "Boost+",
        tabIcon: "i-circle",
        heroBg: "assets/boost-social-bg.webp",
        ...
        categories: [
          { id: "circle-lol", label: "League of Legends", icon: "i-circle", bg: "assets/lol-bg.webp" },
          { id: "circle-valorant", label: "Valorant", icon: "i-circle", bg: "assets/valorant-bg.webp" },
          { id: "circle-egirl", label: "E-Girl", icon: "i-egirl", bg: "assets/boost-social-bg.webp" }
        ],
      ...
      },
      {
        ...
        label: "Faceit",
        tabIcon: "i-star",
        heroBg: "assets/cs2-faceit-bg.webp",
        heroPosition: "center center",
        kicker: "CS2 Faceit",
      ...
      },
      {
        ...
        label: "Premier",
        tabIcon: "i-star",
        heroBg: "assets/cs2-premier-bg.webp",
        heroPosition: "center center",
        kicker: "CS2 Premier",
      ...
      },
      {
        ...
        label: "Arc Raiders",
        tabIcon: "i-raid",
        heroBg: "assets/arc-raiders-bg.webp",
        heroPosition: "center center",
