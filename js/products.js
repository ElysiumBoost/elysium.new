    ...
    const games = [
      {
        ...
        label: "Valorant",
        tabIcon: "i-rank",
        heroBg: "assets/backgrounds/valorant-bg.webp?v=bg-files-final1",
      ...
      },
      {
        ...
        label: "Boost+",
        tabIcon: "i-circle",
        heroBg: "assets/backgrounds/boost-social-bg.webp?v=bg-files-final1",
        ...
        categories: [
          { id: "circle-lol", label: "League of Legends", icon: "i-circle", bg: "assets/backgrounds/lol-bg.webp?v=bg-files-final1" },
          { id: "circle-valorant", label: "Valorant", icon: "i-circle", bg: "assets/backgrounds/valorant-bg.webp?v=bg-files-final1" },
          { id: "circle-egirl", label: "E-Girl", icon: "i-egirl", bg: "assets/backgrounds/boost-social-bg.webp?v=bg-files-final1" }
        ],
      ...
      },
      {
        ...
        tabIcon: "i-star",
        heroBg: "assets/backgrounds/lol-bg.webp?v=bg-files-final1",
        heroPosition: "center center",
      ...
      },
      {
        ...
        tabIcon: "i-star",
        heroBg: "assets/backgrounds/wow-bg.webp?v=bg-files-final1",
        heroPosition: "center center",
      ...
      },
      {
        ...
        label: "Faceit",
        tabIcon: "i-star",
        heroBg: "assets/backgrounds/cs2-faceit-bg.webp?v=bg-files-final1",
        heroPosition: "center center",
        kicker: "CS2 Faceit",
      ...
      },
      {
        ...
        label: "Premier",
        tabIcon: "i-star",
        heroBg: "assets/backgrounds/cs2-premier-bg.webp?v=bg-files-final1",
        heroPosition: "center center",
        kicker: "CS2 Premier",
      ...
      },
      {
        ...
        label: "Arc Raiders",
        tabIcon: "i-raid",
        heroBg: "assets/backgrounds/arc-raiders-bg.webp?v=bg-files-final1",
        heroPosition: "center center",
