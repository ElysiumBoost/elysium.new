    ...
    const games = [
      {
        ...
        label: "Valorant",
        tabIcon: "i-rank",
        homeCardImage: "assets/backgrounds/valorant-home-card.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/valorant-bg.webp?v=social-card-image1",
      ...
      },
      {
        ...
        label: "Boost+",
        tabIcon: "i-circle",
        homeCardImage: "assets/backgrounds/boost-social-home-card.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/boost-social-bg.webp?v=social-card-image1",
        ...
        categories: [
          { id: "circle-lol", label: "League of Legends", icon: "i-circle", bg: "assets/backgrounds/lol-bg.webp?v=social-card-image1" },
          { id: "circle-valorant", label: "Valorant", icon: "i-circle", bg: "assets/backgrounds/valorant-bg.webp?v=social-card-image1" },
          { id: "circle-egirl", label: "E-Girl", icon: "i-egirl", bg: "assets/backgrounds/boost-social-bg.webp?v=social-card-image1" }
        ],
      ...
      },
      {
        ...
        label: "Social",
        tabIcon: "i-star",
        homeCardImage: "assets/backgrounds/boost-social-bg.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/boost-social-bg.webp?v=social-card-image1",
      ...
      },
      {
        ...
        tabIcon: "i-star",
        homeCardImage: "assets/backgrounds/lol-home-card.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/lol-bg.webp?v=social-card-image1",
        heroPosition: "center center",
      ...
      },
      {
        ...
        tabIcon: "i-star",
        homeCardImage: "assets/backgrounds/wow-home-card.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/wow-bg.webp?v=social-card-image1",
        heroPosition: "center center",
      ...
      },
      {
        ...
        label: "Faceit",
        tabIcon: "i-star",
        homeCardImage: "assets/backgrounds/cs2-faceit-home-card.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/cs2-faceit-bg.webp?v=social-card-image1",
        heroPosition: "center center",
        kicker: "CS2 Faceit",
      ...
      },
      {
        ...
        label: "Premier",
        tabIcon: "i-star",
        homeCardImage: "assets/backgrounds/cs2-premier-home-card.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/cs2-premier-bg.webp?v=social-card-image1",
        heroPosition: "center center",
        kicker: "CS2 Premier",
      ...
      },
      {
        ...
        label: "Arc Raiders",
        tabIcon: "i-raid",
        homeCardImage: "assets/backgrounds/arc-raiders-home-card.webp?v=social-card-image1",
        heroBg: "assets/backgrounds/arc-raiders-bg.webp?v=social-card-image1",
        heroPosition: "center center",
